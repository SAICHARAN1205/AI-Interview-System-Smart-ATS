...
public class TogetherAIProperties implements ChatCompletionProviderProperties {

    private boolean enabled = true;
    private String apiKey;
    private String model = "meta-llama/Llama-3-70b-chat-hf";
    private String baseUrl = "https://api.together.xyz";
    private int connectTimeoutMillis = 4000;
    private int readTimeoutMillis = 12000;
    private int maxRetries = 0;
    private long retryDelayMillis = 1000L;
    private long queueSpacingMillis = 500L;
